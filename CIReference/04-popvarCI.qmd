...
To find the corresponding quantiles from a $\chi^2$ distribution with $n-1$ degrees of freedom, $\chi^2_{1-\frac{\alpha}{2};n-1}$ and $\chi^2_{\frac{\alpha}{2};n-1}$, the function `qchisq()` can be used (see the [Probability functions](../Lab5/02-functions.html#sec-prob-func){target="blank"} section of Lab 3 for more details).
...
To find the corresponding quantiles from an $F$ distribution with $n_Y-1$ and $n_X-1$ degrees of freedom, $f_{\frac{\alpha}{2};n_Y-1;n_X-1}$ and $f_{1-\frac{\alpha}{2};n_Y-1;n_X-1}$, the function `qf()` can be used (see the [Probability functions](../Lab5/02-functions.html#sec-prob-func){target="blank"} section of Lab 3 for more details).
