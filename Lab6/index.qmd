...
Welcome to the sixth S2S lab. This lab expands on the concept of sampling distributions (introduced in [Lab 5](../Lab5/index.html){target="_blank"}) to look at the scenario of sampling from continuous distributions other than the normal distribution. To help us do this, we introduce an important result in statistics know as the central limit theorem. This section of the lab follows Section **6.5.1.2 Second Case: Sampling Distribution of $\bar X$ When $X$ Is Not a Normal Random Variable** of *Probability and Statistics with R*.
