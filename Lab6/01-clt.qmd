...
The same process is used to draw the samples from the Exponential distribution, except the function `rexp()` is used to draw the random samples (for more details on R's probability functions see [Lab 5: Section 3](../Lab5/02-functions.html#sec-prob-func){target="_blank"}).
...
Now, we are ready to plot the two sampling distributions of $\bar X$ from the $\mbox{Unif}(-11,\, 41)$ and $\mbox{Expo}\Big(\textstyle\frac{1}{15}\Big)$ distributions. This can be done using the `ggplot2` package (see [Lab 4: Appendix A](../Lab4/06-ggplot.html){target="_blank"}) using the following code.
...
ggplot(data = means_2) +
  ...
  stat_function(fun = dnorm, 
                args = list(mean = 15, sd = 15/sqrt(2)),
                col = "black", 
                linetype = 2, 
                fill = "black",
                alpha = 0.2, 
...
ggplot(data = subset(means, subset = (size == "n = 10"))) +
  ...
  labs(title = "Simulated sampling distributions of the sample mean",
       ...
       y = "Density") +
  stat_function(fun = dnorm, 
                args = list(mean = 15, sd = 15/sqrt(10)),
                geom = "area", 
                col = "black", 
                linetype = 2,
                fill = "black", 
...
ggplot(data = subset(means, subset = (size == "n = 40"))) +
  ...
  labs(title = "Simulated sampling distributions of the sample mean",
       ...
       y = "Density") +
  stat_function(fun = dnorm, 
                args = list(mean = 15, sd = 15/sqrt(40)),
                geom = "area", 
                col = "black", 
                linetype = 2,
                fill = "black", 
...
`r mcq(c("geom_dens", answer="geom_density", "density"))``(aes(x = mean),`
</ul>
<ul style="margin-top:-1em; margin-left:7em;">
`fill = "skyblue") +`
</ul>
...
`args = list(mean = ``r fitb(15)``, sd = ``r fitb(c("15/sqrt(100)", "1.5"), width = 10)``),`
</ul>
<ul style="margin-top:-1em; margin-left:6.4em;">
`geom = ``r fitb("\"area\"")``,`
</ul>
<ul style="margin-top:-1em; margin-left:6.4em;">
`col = "black",`
