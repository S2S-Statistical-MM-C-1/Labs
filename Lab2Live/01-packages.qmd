...
The textbook [*Probability and Statistics with R*](https://read.kortext.com/reader/pdf/92741){target="_blank"} uses the `PASWR2` package throughout. To install this package, run the following code.
...
For more information on installing and loading packages, see [Section 1.8 Packages](https://read.kortext.com/reader/pdf/92741/19){target="_blank"} in *Probability and Statistics with R*.
