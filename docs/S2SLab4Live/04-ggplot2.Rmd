...
::: {.webex-box .webex-check}
**Create a histogram, using ggplot2, showing the ages of all passengers on the Titanic.**
...
`r hide("Show plot")`
```{r gg-ans2.1, echo=FALSE, warning=FALSE, fig.align='center'}
ggplot(data = TITANIC3) +
...
::: {.webex-box .webex-check}
**Complete the code below to create a histogram and density plots which show the distribution of passenger age for each class of passengers on board the Titanic.**
