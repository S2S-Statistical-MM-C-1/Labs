...
document.addEventListener('DOMContentLoaded', function () {
  // Start all example containers in a collapsed state
  document.querySelectorAll('.example-container').forEach(container => {
    container.classList.add('collapsed');
  });

  // Set up the click event to toggle collapse on the header
  document.querySelectorAll('.example-header').forEach(header => {
    header.addEventListener('click', () => {
      const content = header.parentElement.querySelector('.example-container');
      if (content) {
