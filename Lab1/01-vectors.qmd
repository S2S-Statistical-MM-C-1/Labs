...
The resulting vector is `"FALSE" "TRUE" "FALSE" "dog" "sheep" "cow" "horse"` which we can see is stored by R as a character vector. Each element is now considered to be a string of text (note the quotation marks around each element). `r unhide()`
:::
:::
