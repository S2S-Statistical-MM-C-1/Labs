...
The textbook [*Probability and Statistics with R*](https://www-taylorfrancis-com.ezproxy1.lib.gla.ac.uk/reader/read-online/59b6523e-f921-4599-8d9e-20af1058199a/book/epub?context=ubx){target="_blank"} uses the `PASWR2` package throughout. To install this package, run the following code.
