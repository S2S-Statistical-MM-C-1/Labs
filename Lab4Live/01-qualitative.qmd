...
Frequency tables can be created in R using the `table()` function. We have already seen `table()` used in [Lab 3](../Lab3/02-data.html#summarising-data){target="_blank"}, but let's revisit it with an example.
